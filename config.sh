...
sed -E 's/ZSH_THEME="(.*)"/ZSH_THEME="powerlevel10k\/powerlevel10k"/' .zshrc | grep ZSH_THEME

cat << EOF >> ~/.p10k.zsh
# Generated by Powerlevel10k configuration wizard on 2026-06-13 at 09:38 EDT.
